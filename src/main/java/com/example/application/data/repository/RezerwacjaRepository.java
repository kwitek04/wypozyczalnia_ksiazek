...
public interface RezerwacjaRepository extends JpaRepository<Rezerwacja, Long> {
    ...
    List<Rezerwacja> findByUzytkownikOrderByDataRezerwacjiDesc(Uzytkownik uzytkownik);
    ...
    long countByUzytkownikAndStatus(@Param("uzytkownik") Uzytkownik uzytkownik, @Param("status") StatusRezerwacji status);
