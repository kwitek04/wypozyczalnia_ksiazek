...
public interface WypozyczenieRepository extends JpaRepository<Wypozyczenie, Long> {
    List<Wypozyczenie> findAllByUzytkownikOrderByDataWypozyczeniaDesc(Uzytkownik uzytkownik);

    long countByUzytkownikAndDataOddaniaIsNull(Uzytkownik uzytkownik);
    ...
    List<Wypozyczenie> findAllByUzytkownik(Uzytkownik uzytkownik);
}